...
$archive_hero = bywa_eco_get_archive_hero_data('realisation');
?>
<main id="primary" class="site-main bywa-page-layout bywa-page-layout--hero-mini">
    ...
    <section class="bywa-page-content">
        <div class="container py-5">
            <?php echo do_shortcode('[bywa_realisations template="list" limit="10" orderby="menu_order" order="ASC" archive_link="yes"]'); ?>
        </div>
    </section>
</main>
<?php get_footer(); ?>
